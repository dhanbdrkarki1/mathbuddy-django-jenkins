            ...
            steps {
                script {
                    withSonarQubeEnv('sonarqube') {
                        ...
                        -Dsonar.sources=. \
                        -Dsonar.exclusions=venv,requirements.txt,migrations,asgi.py,wsgi.py,manage.py,settings.py,__init__.py, static/jet, static/admin, static/range_filter, static/rest_framework \
